...
**Rung 3 (~$1M+):** Mental Gym conversion at scale. Library for Labs pilot with one lab partner. International expansion. This is the round where the dataset becomes the moat.
...
*- Returns: depend on entry point and round size. The near-zero cost base means even modest revenue produces strong multiples. Full sensitivity in Numbers.xlsx. Three return paths: subscription growth, Library for Labs B2B, strategic exit.*
