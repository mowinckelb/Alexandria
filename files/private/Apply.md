# Apply — Fundraise & Distribution Tracker

Action file. Deadlines, strategy, per-investor ammunition. Updated as things move.

---

## Strategy (March 2026)

Three paths, ordered by priority:

1. **YC S26** — Primary. Network + signal + 3-month forced function. $500K ($125K for 7% + $375K uncapped SAFE MFN). Deadline: May 4, 2026.
2. **One angel in SF** — Secondary. $25-50K from someone who meets the founder and bets on him. Conversation, not application.
3. **Bootstrap** — Tertiary. Parents: $1K/month x 10 months. Company: $100/month. Alive indefinitely.

**Why raise at all:** The company does not need capital to survive. Capital accelerates the demand experiment ($15K seeds 25 users), provides SF network density (accelerator = room with 200 founders), and produces signal (YC acceptance changes every subsequent conversation). The founder also wants the experience — fundraising as founder skill development, P3 arena.

**Why now:** ai market is hot ($258.7B in 2025, 61% of global VC). Pre-seed median valuation $7.7M with 42% ai premium (~$10.9M). The window for "conviction bet with no traction" is open now and closing. After 6 months of data, the story is either "here's what happened" or nothing — raise now from conviction, not later from proof.

**The frame:** Fund distribution of a finished product, not development. Technical risk is zero. The only question is demand. The product is built. The philosophy is written. The money answers one question.

---

## YC S26 Application

**Deadline:** May 4, 2026 at 8pm PT. Batch: July-September 2026.

**Key framing for YC specifically:**
...
- Break-even at 21 subscribers. Cannot die.
- Library v1 live with 24 API endpoints
- Autonomous CTO (daily health, weekly meta)
- git history shows rapid iteration and principled pivots
- Formal proof chain (Logic.md) shows rigorous thinking

**Apply:** ycombinator.com/apply
**Terms:** $500K ($125K for 7% + $375K uncapped SAFE MFN)
**Note:** YC historically friendly to solo founders. Most solo-founder-friendly top-tier program.
...
- **What:** 6 founders, 3 months in SF, $100K investment. Purpose-built for solo founders.
- **Apply:** solofounders.com/program
- **Deadline:** Cohort starts May 22, 2026
- **Terms:** 2.5% + $100K MFN SAFE
- **Why:** Designed for exactly this situation. Small cohort, high-touch. Compatible with YC application.
- **Note:** Cannot sponsor visas directly but provides advice/intros. Former residents have secured O-1 visas.

### Menlo Anthology Fund
- **What:** Anthropic partnership fund. $100K+ investment + Anthropic credits + access to Anthropic technical leaders.
- **Apply:** menlovc.com/anthology-fund-application (rolling)
- **Why:** Alexandria is built for the Claude ecosystem. Direct Anthropic network access.

### South Park Commons Founder Fellowship
- **What:** "Anti-accelerator." Exploration-first. $400K for 7% + $600K in next round.
- **Apply:** Spring 2026 active (rolling)
- **Why:** Philosophy resonates — deep exploration before commitment. $500M fund (Jan 2026).

### a16z Speedrun
- **What:** 12 weeks in SF. $500K for 10% + $500K in next round. $5M+ in credits.
- **Apply:** Watch for SR007 applications
- **Why:** Demo Day with 1,000+ investors. Massive credit package.

---

## Investor Sniper Sheets
...
### Elad Gil — Solo GP / super angel (~$3B fund)
- **Believes:** "Market-creating companies." Uses ai products to evaluate. "Anyone's game" outside locked-up categories. Backs unconventional solo operators.
- **Likely objection:** "Where's the market proof?"
- **Ammunition:** Terminal value attack — "your other ai investments are bridge companies. This is position 2." The product itself when he pastes Memo.md into Claude. The formal argument (Logic.md). The git history.
- **Path:** SF ai community. Direct outreach. The Memo IS the pitch — designed to be pasted into ai.
- **Portfolio:** Perplexity, Character.ai, Harvey, Mistral, OpenAI

### Sarah Guo — Conviction ("Software 3.0")
- **Believes:** Previous market assumptions invalid. ai rewrites all software categories.
- **Likely objection:** "Solo founder, no traction."
- **Ammunition:** Process-as-proof. $100/month opex as the literal proof of Software 3.0. "Every employee is an ai agent." The company IS what Software 3.0 looks like.
- **Path:** conviction.com. Podcast/Twitter engagement. No Priors podcast with Elad Gil.
- **Deals:** Harvey ($3B), Mistral ($6B), Sierra ($4.5B)

### Khosla Ventures — $650M seed-stage fund
- **Believes:** "Bold bets on transformative tech." Willing to fail.
- **Likely objection:** "Is this a real company or a philosophy project?"
- **Ammunition:** Rope swing — product blitz first. Library v1. 24 endpoints. Stripe integration. Then philosophy. The formal proof chain (Logic.md) proves rigorous thinking, not just dreaming.
- **Path:** Through MCP ecosystem (Keith Rabois backed Runlayer, $11M MCP security).

### Naval Ravikant — dream investor
- **Believes:** Everything Alexandria believes. Polymath, sovereign individual, "specific knowledge," "the best books are read twice."
- **Likely objection:** May not actively invest in pre-seed anymore.
- **Ammunition:** Don't pitch. Show him the Constitution. Show him his own quotes woven into the thesis. He IS the target Author. The product was built for people who think like Naval.
- **Path:** Through Ayo/SF network. This is a relationship play, not a pitch play.

### Air Street Capital (Nathan Benaich) — Solo GP, $232M Fund III
- **Believes:** ai-first companies that own end-to-end outcomes.
- **Likely objection:** "Consumer is hard. Where's the distribution?"
- **Ammunition:** Three channels (local, network, global). The Library's viral mechanics. $100/month opex means infinite runway to find distribution.
- **Path:** State of ai Report community. Direct outreach. NA + Europe coverage ideal for EU→SF founder.
- **Check:** $500K–$15M. Leads early-stage.

### Felicis (Peter Deng as dual path) — $900M FV X
- **Believes:** ai infrastructure as "railways." 70% of portfolio ai-native.
- **Likely objection:** "Is this infrastructure or consumer?"
- **Ammunition:** It's both. The infrastructure (sovereign cognitive files) enables the consumer product (the Library). Peter Deng (ex-OpenAI consumer) understands ai identity/personalisation.
- **Path:** Through Anthropic/MCP network. Deng as angel + fund intro.

### SV Angel / Seven Stars (Steven Lee) — $250K-500K pre-seed
- **Believes:** SV Angel: 45 pre-seed companies in 2025, 77 unicorns. Seven Stars: $40M debut fund purpose-built for seed/pre-seed ai.
- **Path:** SF network. Low friction. Right stage.
...
## SF Events Calendar (April-June 2026)

| Date | Event | Notes |
|------|-------|-------|
| Mar 30-Apr 3 | Deep Tech Week | 38 events |
| Apr 6-9 | HumanX (Moscone) | "Davos for ai." 3,000+ attendees |
| Apr 11 | ai Tinkerers SF | Monthly. "ai That Works: Unconference" |
| Apr 28-29 | ai Dev 26 x SF | Andrew Ng's DeepLearning.ai. 3,000+ devs |
| May 4 | AgentCon SF | Developer-focused ai agents |
| May 13-14 | LLM.js Conference | Dogpatch |
| Ongoing | Cerebral Valley | 40K+ founders. Weekly events. **Join immediately on landing.** |
| Ongoing | Bond ai SF | Regular Bay Area ai events |

**Strategy:** First 2 weeks = pure reconnaissance. No pitching. Ask questions. Map the landscape. Learn who matters and what they need to hear.

---

## Sequencing

**Phase 1 — April:** Land in SF. Join Cerebral Valley. Attend HumanX (Apr 6-9), ai Tinkerers (Apr 11), ai Dev (Apr 28-29). Meet everyone. Pitch no one. Learn who matters. Apply to YC, Solo Founders, Menlo Anthology.

**Phase 2 — May:** YC deadline (May 4). Start targeted angel conversations based on April reconnaissance. Solo Founders cohort (May 22). AgentCon (May 4), LLM.js (May 13-14). The meetings that matter, with the people mapped in April, armed with docs that are sharp.

**Phase 3 — Summer:** Accelerator batch (if accepted). First traction data from founding seeds. This data determines the next raise story. If no accelerator: bootstrap, build users, raise from strength in fall.

**Key insight:** The amount and terms are a conversation, not a declaration. Let the relationship and the data determine the right structure.

---

## Market Context

- ai = 61% of all global VC ($258.7B in 2025). Feb 2026 was largest single month ever ($189B).
- Pre-seed median valuation: $7.7M. ai gets 42% premium (~$10.9M).
- 92% of pre-seed on post-money SAFE.
- Solo-founded = 35% of US startups but 17% of VC-funded. Frame ai agents as the team.
- ai companion market projected $476B by 2034.

---

## Visa

- O-1A (extraordinary ability) is the primary path. No fixed investment requirement.
- Based on professional achievements. YC/accelerator acceptance strengthens the case.
- Solo Founders Program provides advice/intros for visa process.
