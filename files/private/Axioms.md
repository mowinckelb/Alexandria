...
- **Ontology = thoughts.** Structured, not yet Author-confirmed. The Engine's workspace. The Engine processes vault material and produces candidate fragments — extracted signal, identified patterns, surfaced contradictions. This layer is the Engine's hypothesis about the Author's cognition. It is not yet truth. It is proposal.

- **Constitution = beliefs.** Author-confirmed, load-bearing, governing. When the Author confirms an ontology fragment — "yes, that's what I think" or "close, but more like this" — it crosses into the Constitution. The Constitution governs how every function operates for this Author. It is the symbolic layer made explicit. The confirmation step is sacred: nothing enters the Constitution without the Author's assent.
